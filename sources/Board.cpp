...
namespace pandemic
{
    map<City, set<City>> Board::connection =
    ...
    bool Board::hasDisCure(Color color)
    {
        return (discoveredCure.count(color) > 0);
    }

    bool Board::hasResStation(City city)
    {
        return researchStation.count(city) > 0;
    }

    void Board::addDisCure(Color color)
    {
        discoveredCure.insert(color);
    }

    void Board::addResStation(City city)
    {
